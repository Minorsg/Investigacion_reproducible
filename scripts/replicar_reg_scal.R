...
#
# La regresión escalonada es un procedimiento que podemos utilizar para construir un modelo de regresiÃ³n a partir de un conjunto de variables predictoras candidatas ingresando y eliminando predictores de manera escalonada en el modelo hasta que no haya una razón "estadísticamente válida" (según sus apílogos) para ingresar o quitar más.
#
# El objetivo de la regresión escalonada (nuevamente, según sus defensores) es crear un modelo de regresión que incluya todas las variables predictoras que están relacionadas de manera estadíticamente significativa con la variable de respuesta.
#
